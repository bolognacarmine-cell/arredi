...
- Name: navigation.e2e.spec.ts >> Navigation >> should navigate to Chi siamo page
- Location: e2e\navigation.e2e.spec.ts:58:7
...
Locator: locator('a[href="/chi-siamo"]')
Expected: visible
Error: strict mode violation: locator('a[href="/chi-siamo"]') resolved to 3 elements:
    1) <a href="/chi-siamo" data-discover="true" class="text-base font-semibold transition-all duration-300 relative group text-[#6B7280] hover:text-[#1A1A2E]">…</a> aka getByRole('navigation').getByRole('link', { name: 'Chi siamo' })
    2) <a href="/chi-siamo" data-discover="true" class="flex items-center min-h-[36px] sm:min-h-[40px] -mx-2 px-2 text-xs sm:text-sm text-white/72 hover:text-[#E69138] hover:bg-white/[0.04] rounded-sm transition-colors">Chi siamo</a> aka locator('#footer-accordion-azienda').getByText('Chi siamo')
    3) <a href="/chi-siamo" data-discover="true" class="flex items-center min-h-[36px] sm:min-h-[40px] -mx-2 px-2 text-xs sm:text-sm text-white/72 hover:text-[#E69138] hover:bg-white/[0.04] rounded-sm transition-colors">Chi siamo</a> aka getByRole('contentinfo').getByRole('link', { name: 'Chi siamo' })

Call log:
  - Expect "toBeVisible" locator('a[href="/chi-siamo"]') with timeout 5000ms
  - waiting for locator('a[href="/chi-siamo"]')
