...
- Name: navigation.e2e.spec.ts >> Navigation >> should navigate to Progetti page
- Location: e2e\navigation.e2e.spec.ts:34:7
...
Locator: locator('a[href="/progetti"]')
Expected: visible
Error: strict mode violation: locator('a[href="/progetti"]') resolved to 5 elements:
    1) <a href="/progetti" data-discover="true" class="text-base font-semibold transition-all duration-300 relative group text-[#6B7280] hover:text-[#1A1A2E]">…</a> aka getByRole('navigation').getByRole('link', { name: 'Progetti' })
    2) <a href="/progetti" data-discover="true" aria-label="Vedi i progetti" class="group relative inline-flex items-center justify-center min-h-[40px] sm:min-h-[44px] md:min-h-[48px] border border-white/40 text-white text-[11px] sm:text-xs md:text-sm font-semibold px-3 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 lg:py-4 overflow-hidden hover:border-white/70 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">…</a> aka getByRole('link', { name: 'Vedi i progetti' })
    3) <a href="/progetti" data-discover="true" class="inline-flex items-center self-start min-h-[36px] sm:min-h-[40px] -ml-2 px-2 text-[#E69138] text-xs sm:text-sm font-medium hover:underline rounded-md">Vedi tutti i progetti →</a> aka getByRole('link', { name: 'Vedi tutti i progetti →' })
    4) <a href="/progetti" data-discover="true" class="flex items-center min-h-[36px] sm:min-h-[40px] -mx-2 px-2 text-xs sm:text-sm text-white/72 hover:text-[#E69138] hover:bg-white/[0.04] rounded-sm transition-colors">Progetti</a> aka locator('#footer-accordion-azienda').getByText('Progetti', { exact: true })
    5) <a href="/progetti" data-discover="true" class="flex items-center min-h-[36px] sm:min-h-[40px] -mx-2 px-2 text-xs sm:text-sm text-white/72 hover:text-[#E69138] hover:bg-white/[0.04] rounded-sm transition-colors">Progetti</a> aka getByRole('contentinfo').getByRole('link', { name: 'Progetti' })

Call log:
  - Expect "toBeVisible" locator('a[href="/progetti"]') with timeout 5000ms
  - waiting for locator('a[href="/progetti"]')
