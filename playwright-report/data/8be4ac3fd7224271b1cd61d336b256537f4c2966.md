...
- Name: home.e2e.spec.ts >> Home Page >> should navigate to sectors from home
- Location: e2e\home.e2e.spec.ts:42:7
...
Call log:
  - waiting for locator('a[href^="/settori/"]').first()
    - locator resolved to <a data-discover="true" href="/settori/barbieri" class="group relative overflow-hidden bg-white aspect-[3/4] flex flex-col justify-end p-4 sm:p-5 md:p-6  fade-in-up glow-pulse magnetic-hover hover:shadow-2xl hover:shadow-[#E69138]/20 hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500 ease-out">…</a>
