  ...
  return (
    <footer className="relative overflow-hidden bg-[#11111F] text-white">
      ...
      <div className="relative border-b border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-6 md:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-16">
      ...
      <div className="relative border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-4 text-xs text-white/48 md:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-16">
          <span>
