  ...
  return (
    <footer className="bg-[#1A1A2E] text-white">
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-16 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-1">
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                ...
                className="w-8 h-8 border border-white/20 flex items-center justify-center text-xs text-[#6B7280] hover:border-[#E69138] hover:text-[#E69138] transition-colors"
              >
                {icon}
              </a>
            ))}
          ...
          <div className="mt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366] text-white text-xs font-semibold px-4 py-2.5 hover:bg-[#128C7E] transition-colors"
            >
        ...
        <div>
          <h4 className="text-xs font-semibold tracking-[0.2em] uppercase text-[#6B7280] mb-5">
            Settori
          </h4>
            ...
            {sectors.map((s, i) => (
              <li key={s}>
                <Link
                  ...
                  className="text-sm text-white/80 hover:text-[#E69138] transition-colors"
                >
                  {s}
                </Link>
              </li>
          ...
          <ul className="space-y-3 text-sm text-white/80">
            ...
            <li>
              <a
                ...
                className="hover:text-[#E69138] transition-colors"
              >
                +39 0823 694427
              </a>
            </li>
            <li>
              <a
                href="mailto:farcomsrl@hotmail.com"
                className="hover:text-[#E69138] transition-colors"
              >
                farcomsrl@hotmail.com
              </a>
            </li>
            <li className="text-[#6B7280]">Lun–Ven 9:00–13:00 / 15:00–19:00</li>
          </ul>
        </div>
      </div>
